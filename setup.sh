...
FILE_AREA_ADM_SUPER(){
  echo '-----------------------------------------'
  echo 'CRIANDO ARQUIVO AREA ADMINISTRATIVA SUPER'
  echo '-----------------------------------------'
  touch area_adm_super.sh
cat << EOF >> area_adm_super.sh
...
CRIANDO_ARQUIVO_MIGRAÇÃO(){
  touch migrations.sh

cat << EOF >> migrations.sh
CREATE_MIGRATION(){
echo '////////////////////'
...
CRIANDO_ARQUIVOS_SH_DESENVOLVIMENTO_TURBO(){
# criando arquivo e conteudo area_adm_super
FILE_AREA_ADM_SUPER
# criando arquivo de migração
CRIANDO_ARQUIVO_MIGRAÇÃO
# script roda servidor
CREATE_FILE_RUN_SERVER
}
